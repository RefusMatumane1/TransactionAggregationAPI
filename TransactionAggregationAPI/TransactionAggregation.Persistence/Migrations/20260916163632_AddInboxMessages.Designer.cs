...
namespace TransactionAggregation.Persistence.Migrations
{
    ...
    [Migration("20260916163632_AddInboxMessages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TransactionAggregation.Domain.Entities.Account", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TransactionAggregation.Domain.Entities.WebhookSource", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("WebhookSources", (string)null);
                });

            modelBuilder.Entity("TransactionAggregation.Domain.Inbox.InboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TransactionAggregation.Domain.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TransactionAggregation.Domain.Entities.Transaction", b =>
                {
                    b.HasOne("TransactionAggregation.Domain.Entities.Account", null)
